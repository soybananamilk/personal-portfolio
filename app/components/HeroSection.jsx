    ...
    return (
        <section>
            <div className="grid grid-cols-1 sm:grid-cols-12">
                ...
                <div>
                    <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-[#655437] via-[#AFAD8B] to-[#EDEDE3] hover:text-[#EDEDE3] text-[#262717] border">Hire Me</button>
                    <button className="px-1 py-1 w-full sm:w-fit rounded-full bg-transparent bg-gradient-to-br from-[#AFAD8B] to-[#EDEDE3] hover:text-[#EDEDE3] text-[#EDEDE3] mt-3">
                        <span className="block bg-[#655437] hover:bg-[#AFAD8B] rounded-full px-5 py-2">Download CV</span>
                    </button>
                </div>
                </div>
                <div className="col-span-5 place-self-center mt-4 lg:mt-0 ">
                    <div className="rounded-full bg-[#AFAD8B] w-[500px] h-[400px] lg:w-[500px] lg:h-[400px] relative bg-opacity-75 hover:bg-opacity-50">
                        <Image
